        ...
        area(Content)
        {
            ...
            group("Authentication")
            {
                ...
                field(GrantType; GrantType)
                {
                    ApplicationArea = All;
                    Caption = 'Grant Type';
                    //OptionCaption = 'Client Credentials(v1.0),';
        ...
        area(Processing)
        {
            ...
            action(callitemapi)
            {
                ...
                var
                    ...
                    jsontext: Text;
                begin
                    Message('%1', ResourceURL);
                    RequestMessage.GetHeaders(RequestHeaders);
                    RequestHeaders.Add('Authorization', 'Bearer ' + AccessToken);
                    IF httprequest.Get('https://api.businesscentral.dynamics.com/v2.0/98b50d32-8c4b-4c4f-947b-6b9c4e7c0c2c/Production/api/v2.0/companies(64d41503-fcd7-eb11-bb70-000d3a299fca)/items'
                    , responseMessage)
                     THEN begin
